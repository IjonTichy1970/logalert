...
probe, a rename under an open handle -- each saying "runs in the sandbox and on
CI"; 45 as of #32). In the root sandbox the non-root tests skip instead, saying
"expected in the root sandbox; CI runs it" (7 as of #32), plus one Windows-only
